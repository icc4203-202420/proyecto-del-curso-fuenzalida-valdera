...
const Map = () => {
  ...
  // Función para obtener los bares desde la API
  ...
  // Cargar la información de los bares al inicializar el componente
  useEffect(() => {
    ...
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '16px', marginTop: '16px' }}>
        <TextField
          ...
          value={searchTerm}
          style={{ backgroundColor: 'white', marginRight: '8px' }} // Color de fondo y margen para espaciado
        />
